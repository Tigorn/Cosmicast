...
//  Flightbase
//
//  Created by Shihab Mehboob on 25/05/2018.
...
final class VisualActivityViewController: UIActivityViewController {
    ...
    var previewLinkColor: UIColor = UIColor(red: 1, green: 1, blue: 1, alpha: 1)
    
    /// The font for the preview label
    var previewFont: UIFont = UIFont.boldSystemFont(ofSize: 20)
    ...
    override func viewDidLoad() {
        ...
        preview = UIVisualEffectView(effect: UIBlurEffect(style: .dark))
        ...
        for (index, item) in activityItems.enumerated() {
            ...
            if let url = item as? URL {
                ...
                urlAttributes[.foregroundColor] = UIColor.white
                urlAttributes[.font] = UIFont.boldSystemFont(ofSize: 15)
                ...
                urlAttributes[.foregroundColor] = UIColor.white
                urlAttributes[.font] = UIFont.boldSystemFont(ofSize: 15)
                attributedString.append(NSAttributedString(string: text, attributes: urlAttributes))
            }
        }
